...
class DocsSearch extends Docs
{
    ...
    public function rules()
    {
        return [
            ...
            [['surname', 'name', 'mname', 'citizenship_id', 'pre_surname', 'pre_name', 'pre_mname','pre_citizenship_id', 'birth_date', 'birth_place', 'tel', 'fax', 'type_place', 'type_date', 'fio_father', 'fio_mother', 'study_name', 'study_place', 'study_start_date', 'study_end_date', 'pension_reason', 'pension_date', 'pension_org', 'last_cost', 'last_cost_org', 'doc_target', 'living_place', 'sec_name', 'sec_surname', 'sec_mname', 'sec_citizenship_id', 'sec_birthplace', 'sec_birthdate', 'relative', 'sec_livingplace', 'sec_tel', 'sec_fax', 'scan_file', 'comment', 'email'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            ...
            // 'sec_citizenship_id' => $this->sec_citizenship_id,
            // 'sec_tel' => $this->sec_tel,
            // 'sec_fax' => $this->sec_fax,
            'status_id' => $this->status_id,
            // 'pre_citizenship_id' => $this->pre_citizenship_id,
