...
class CitizenshipSearch extends Citizenship
{
    ...
    {
        return [
            [['id', 'nationality_id', 'study_id', 'profession', 'marital_id', 'marital_nation', 'citizenship_id', 'status_id', 'division_id'], 'integer'],
            [['guide', 'surname', 'name', 'mname', 'pre_surname', 'pre_name', 'pre_mname', 'birth_date', 'marital_name', 'marital_bdate', 'marital_place', 'court', 'army', 'army_now', 'medal', 'pmj', 'last_place', 'visit_uzb', 'business', 'cause', 'living_place', 'tel', 'file1', 'file2', 'file3', 'file4', 'comment'], 'safe'],
        ];
    }
