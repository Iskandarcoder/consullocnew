...
/**
 * SpNationSearch represents the model behind the search form about `backend\models\SpNation`.
 */
class SpNationSearch extends SpNation
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['sp_name_cryl', 'sp_name_ru', 'sp_name_qrc', 'sp_name_en', 'sp_name_uz', 'sp_name_qrl', 'sp_dateenter', 'sp_idn', 'sp_idnold', 'sp_idnfirst'], 'safe'],
        ];
    }
